;;; doom-ventura-theme.el --- Mac OS Ventura -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Based on doom-horizon-theme
...
(defgroup doom-ventura-theme nil
  "Options for the `doom-ventura' theme."
  :group 'doom-themes)

(defcustom doom-ventura-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-ventura-theme
  :type 'boolean)

(defcustom doom-ventura-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-ventura-theme
  :type 'boolean)

(defcustom doom-ventura-comment-bg doom-ventura-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-ventura-theme
  :type 'boolean)

(defcustom doom-ventura-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-ventura
    "A port of the port of the Visual Studio Code theme Horizon"

  ;; name       default    256       16
  ((bg         '("#071320" nil       nil            ))
   (bg-alt     '("#101F2E" nil       nil            ))
   (base0      '("#0E1925" "black"   "black"        ))
   (base1      '("#101F2E" "#111111" "brightblack"  ))
   (base2      '("#132539" "#333333" "brightblack"  ))
   (base3      '("#162C42" "#555555" "white"        ))
   (base4      '("#5D738A" "#6a6a6a" "white"        ))
   (base5      '("#8294A5" "#f9cec3" "white"        ))
   (base6      '("#f9cbbe" "#f9cbbe" "white"        ))
   (base7      '("#fadad1" "#fadad1" "white"        ))
   (base8      '("#fdf0ed" "#fdf0ed" "white"        ))
   (fg-alt     '("#fdf0ed" "#fdf0ed" "brightwhite"  ))
   (fg         '("#e7e9eb" "#c7c9cb" "white"        ))

   (grey       base4)
   (red        '("#FE7867" "#e95678" "red"          ))
   (orange     '("#F5C186" "#f09383" "brightred"    ))
   (green      '("#09f7a0" "#09f7a0" "green"        ))
   (teal       '("#BAEFE1" "#87ceeb" "brightgreen"  ))
   (yellow     '("#F7D381" "#fab795" "yellow"       ))
   (blue       '("#BDBAEF" "#21bfc2" "brightblue"   ))
   (dark-blue  '("#432EBE" "#25b2bc" "blue"         ))
   (magenta    '("#C968CC" "#6c6f93" "magenta"      ))
   (violet     '("#EA6FBD" "#b877db" "brightmagenta"))
   (cyan       '("#BADEEF" "#59e3e3" "brightcyan"   ))
   (dark-cyan  '("#1C658C" "#27d797" "cyan"   ))

   ;; additional highlighting colours for ventura
   ...
   (selection      violet)
   (builtin        violet)
   (comments       (if doom-ventura-brighter-comments magenta grey))
   (doc-comments   yellow)
   (constants      orange)
   (functions      teal)
   (keywords       violet)
   ...
   (-modeline-bright doom-ventura-brighter-modeline)
   (-modeline-pad
    (when doom-ventura-padded-modeline
      (if (integerp doom-ventura-padded-modeline) doom-ventura-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if doom-ventura-comment-bg (doom-lighten bg 0.03)))
...
;;; doom-ventura-theme.el ends here
